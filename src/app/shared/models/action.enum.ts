...
export enum ActionEnum {
  ...
  sailShipToBurialChamber=<any>"sailShipToBurialChamber",
  sailShipToObelisk=<any>"sailShipToObelisk",
  ...
  takeRedMarketCardSarcophargus=<any>"takeRedMarketCardSarcophargus",
  takeRedMarketCardEntrance=<any>"takeRedMarketCardEntrance",
  takeRedMarketCardPavedPath=<any>"takeRedMarketCardPavedPath",
  takeVioletMarketCard=<any>"takeVioletMarketCard",
  takeVioletMarketCardStatues=<any>"takeVioletMarketCardStatues",
  takeBlueMarketCard=<any>"takeBlueMarketCard",
  takeBlueMarketCardHammer=<any>"takeBlueMarketCardHammer",
  takeBlueMarketCardSail=<any>"takeBlueMarketCardSail",
  takeBlueMarketCardLever=<any>"takeBlueMarketCardLever",
  takeBlueMarketCardChisel=<any>"takeBlueMarketCardChisel",
